...
if __name__ == "__main__":
    ...
    _debug_root = Path(tempfile.mkdtemp(prefix="pdf_tool_debug_"))
    get_session_context = lambda: str(_debug_root)

    test_dir = _debug_root / "sub_dir"
...
围绕“增长、转化、风控、合规”四个关键词设计分析框架，并将检索结果与上传材料统一整理成可交付报告。
""",
        encoding="utf-8",
    )
